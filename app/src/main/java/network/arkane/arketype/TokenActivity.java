...
import network.arkane.arketype.client.ArkaneClient;
import network.arkane.arketype.client.AuthStateManager;
import network.arkane.arketype.client.Configuration;
...
public class TokenActivity extends AppCompatActivity {
    ...
    private ArkaneClient arkaneClient;
    ...
    private void getWallets() {
        displayLoading("Fetching wallets");
        mExecutor.submit(() -> {
            AuthState state = mStateManager.getCurrent();
            state.performActionWithFreshTokens(mAuthService, (accessToken, idToken, ex) -> {
    ...
    private void displayAuthorized() {
        ...
        if (state.getAccessToken() == null) {
            ...
            if (expiresAt == null) {
                ...
                ZonedDateTime date = Instant.ofEpochMilli(expiresAt).atZone(ZoneId.systemDefault());
                accessTokenInfoView.setText(
                        String.format(
                                template,
