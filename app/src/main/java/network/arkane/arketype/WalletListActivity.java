 ...
 * lead to a {@link WalletDetailActivity} representing
...
public class WalletListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.wallet_detail_container) != null) {
    ...
    public static class SimpleItemRecyclerViewAdapter
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    mParentActivity.getSupportFragmentManager().beginTransaction()
                            .replace(R.id.wallet_detail_container, fragment)
                            .commit();
                } else {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.wallet_list_content, parent, false);
